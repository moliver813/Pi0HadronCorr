...
*/
  ...
  std::vector<TH1D *> hInvarMassPtBinMCUnMatchNoPeakRatio;
  std::vector<TH1D *> hInvarMassPtBinMCCorrBkg;
  std::vector<TH1D *> hInvarMassPtBinMCCorrBkgRatio;
...
// Note that the final correlations were donw with all 1-5 for lambda.


Double_t fPi0MassFixedValue_4[kNCentBins][9] = {
...
Double_t fPi0SigmaFixedValue_4[kNCentBins][9] = {
...
// 2020 GA Windows
Double_t fPi0MassFixedValue_5[kNCentBins][9] = {
...
Double_t fPi0SigmaFixedValue_5[kNCentBins][9] = {
